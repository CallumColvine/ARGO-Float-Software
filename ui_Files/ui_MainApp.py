...
#
# Created: Wed Jun 01 10:03:03 2016
...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        self.sampleWindowBox.setProperty("value", 20)
        ...
        spacerItem32 = QtGui.QSpacerItem(583, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        self.nextButton_2 = QtGui.QPushButton(self.calculationsPage)
        self.nextButton_2.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.nextButton_2.setFont(font)
        self.nextButton_2.setObjectName("nextButton_2")
        self.horizontalLayout_22.addWidget(self.nextButton_2)
    ...
    def retranslateUi(self, MainApp):
        ...
        self.nextButton_2.setText(QtGui.QApplication.translate("MainApp", "Next", None, QtGui.QApplication.UnicodeUTF8))
