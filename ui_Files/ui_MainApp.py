...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        spacerItem8 = QtGui.QSpacerItem(20, 330, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.MinimumExpanding)
    ...
    def retranslateUi(self, MainApp):
        ...
        self.argoPathLineEdit.setText(QtGui.QApplication.translate("MainApp", "C:\\Users\\ColvineC\\IOS_DFO\\ARGO-Float-Software\\", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MainApp", "Program Install Path", None, QtGui.QApplication.UnicodeUTF8))
